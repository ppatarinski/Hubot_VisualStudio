...
2. Put a break point in the js file of script you want to debug
...
3. Run the project it will start Hubot in command line 
4. Type in "hubot ping"
5. You should see the breakpoint get hit in the js project
